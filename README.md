...
The finance dataset is used for structured sales and customer-related questions. The Amazon Employee Access dataset is used as an external structured dataset for access-governance style questions.
